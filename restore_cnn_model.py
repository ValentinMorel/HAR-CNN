...
class ImportGraph():
    ...
    def __init__(self, loc):
        ...
        with self.graph.as_default():
            saver = tf.train.import_meta_graph('C:/Python35/tmp/model_cnn-1000' + '.meta',clear_devices=True)
            saver.restore(self.sess, 'C:/Python35/tmp/model_cnn-1000')
...
model = ImportGraph('C:/Python35/tmp/model_cnn-1000')
print('Working...')
